...
| cover.png | Cover image used in the project README. |
| README.md | Project documentation, methodology, results, and usage instructions. |
...
```bash
git clone https://github.com/Mawcinitt777/olympic-swimming-medal-prediction.git
cd olympic-swimming-medal-prediction
```
...
Open `Olympic_Swimming_Medal_Prediction.ipynb` and run the notebook cells in order.
